...
public class SplashScreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ObjectAnimator anim3 = ObjectAnimator.ofFloat(tv_logo, "translationY", -200, 0);
        anim3.setDuration(2500);
        ObjectAnimator anim4 = ObjectAnimator.ofFloat(tv_logo, "alpha", 0, 1);
        anim4.setDuration(2500);
        AnimatorSet ans2 = new AnimatorSet();
        ans2.play(anim3).with(anim4);
        ans2.start();
                    ...
                    if(firstTime==0){
                        ...
                        if(shared != null){
                            ...
                            if(token.length() == 0 && password.length() == 0){
                                ...
                                startActivity(new Intent(SplashScreenActivity.this, ControllerActivity.class));
                                finish();
                            }
                        }
                    }
